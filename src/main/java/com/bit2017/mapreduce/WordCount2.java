...
public class WordCount2 {
	...
	public static class MyMapper extends Mapper<Text, Text, Text, NumberWritable> {
		private Text word = new Text();
		private static NumberWritable one = new NumberWritable(1L);

		@Override
		protected void map(Text key, Text value, Mapper<Text, Text, Text, NumberWritable>.Context context)
